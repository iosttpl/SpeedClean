...
- (BOOL)application:(UIApplication *)application
  ...
  // Initialize Parse.
  [Parse setApplicationId:@"245iRTWVZBMOTexYAYimIvjH3t3YTjClnPcfO1fC"
                clientKey:@"nlif6cifLULHMwF2212Jb4gemYUHi6472hJdFQHU"];

  // [Optional] Track statistics around application opens.
  [PFAnalytics trackAppOpenedWithLaunchOptions:launchOptions];

  PFObject *testObject = [PFObject objectWithClassName:@"TestObject"];
  testObject[@"foo"] = @"Andrew";
...
- (NSURL *)applicationDocumentsDirectory {
  ...
  // code uses a directory named "com.storaenso.SpeedClean" in the application's
  // documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
  ...
  NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"SpeedClean"
                                            withExtension:@"momd"];
  _managedObjectModel =
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
  ...
  NSURL *storeURL = [[self applicationDocumentsDirectory]
      URLByAppendingPathComponent:@"SpeedClean.sqlite"];
  NSError *error = nil;
